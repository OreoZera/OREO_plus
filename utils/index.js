...
module.exports.throwError = function (command, threadID, messageID) {
	...
	return global.client.api.sendMessage(`[!] » Dùng lệnh cũng ngu :) vui lòng sử dụng ${(threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : global.config.PREFIX}help ${command} để biết thêm hướng dẫn sử dụng bot.\nNếu bạn quá khó hiểu vui lòng liên hệ ADMIN qua: https://www.facebook.com/DVFB.HMTG2 \nHoặc liên hệ qua zalo: 0911023689. \nXin cảm ơn!`, threadID, messageID);
}
